...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 50.960000 && value <= 785.630000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 785.630000 && value <= 2313.460000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2313.460000 && value <= 4461.890000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4461.890000 && value <= 6871.310000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6871.310000 && value <= 8723.990000) {
            style = [ new ol.style.Style({
